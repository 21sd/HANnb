...
local gradientColors = {
    ...
    local Window = WindUI:CreateWindow({
        ...
        Author = "SL团队",
        Folder = "CloudHub",
        Size = UDim2.fromOffset(580, 440),   -- 保留原尺寸
        Transparent = true,
        Theme = "Midnight",                 -- 新主题
        HideSearchBar = false,
    ...
    local _shieldAttackActive2 = false
    local _shieldAttackThread2 = nil

    F:Toggle({
        Title = "攻击护盾",
        Value = false,
        Callback = function(t)
            _shieldAttackActive2 = t
            
            if t then
                if _shieldAttackThread2 then
                    coroutine.close(_shieldAttackThread2)
                    _shieldAttackThread2 = nil
                end
                
                _shieldAttackThread2 = coroutine.create(function()
                    while _shieldAttackActive2 do
                        ...
                        for _, tycoon in ipairs(tycoonFolder:GetChildren()) do
                            if not _shieldAttackActive2 then break end
