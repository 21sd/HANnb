...
game:GetService('RunService').RenderStepped:Connect(function()
    game.Players.LocalPlayer.Character:FindFirstChild('Humanoid').WalkSpeed = _G.Settings.LocalPlayer["WalkSpeed"]
end);
                        ...
                        if not v.Character.Head:FindFirstChild(("EspPlayer" .. Number)) then
                            ...
                            name.Text = v.Name .. " \n" ..
                                    ...
                                    (((game:GetService("Players")).LocalPlayer.Character.Head.Position -
                                        v.Character.Head.Position)).Magnitude / 3) .. " 距离";
                            name.Size = UDim2.new(1, 0, 1, 0);
                            ...
                            if not v:FindFirstChild(("EspChest" .. Number)) then
                                ...
                                if v.Name == "SilverChest" then
                                    ...
                                    name.Text = "Silver Chest" .. " \n" ..
                                                    round(
                                            (((game:GetService("Players")).LocalPlayer.Character.Head.Position -
                                                v.RootPart.Position)).Magnitude / 3) .. "距离";
                                end
                    ...
                    if v.Name and string.find(v.Name, "Fruit") then
                        if not v.Handle:FindFirstChild(("EspDevilFruit" .. Number)) then
                            ...
                            name.Text = v.Name .. " \n" ..
                                            round(
                                    (((game:GetService("Players")).LocalPlayer.Character.Head.Position -
                                        v.Handle.Position)).Magnitude / 3) .. "距离";
...
spawn(function()
    while wait(1) do
        if not game.Workspace:FindFirstChild('AppleSpawner') then
            return 
        end
        for i, v in pairs(game.Workspace:FindFirstChild('AppleSpawner'):GetChildren()) do
            if v:IsA("Tool") then
            ...
            if _G.Settings.Esp["ESP Monster"] then
                for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
                    if v:FindFirstChild("HumanoidRootPart") then
                        ...
                        v.EspMonster.TextLabel.Text = v.Name .. " - " .. Dis .. " 距离";
                    end
                end
            else
                for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
            ...
            if _G.Settings.Esp["ESP Sea Beast"] then
                for i, v in pairs((game:GetService("Workspace")).SeaBeasts:GetChildren()) do
                    if v:FindFirstChild("HumanoidRootPart") then
                        ...
                        local Dis = math.floor((game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
                                                   v.HumanoidRootPart.Position).Magnitude);
                        v.EspSeabeasts.TextLabel.Text = v.Name .. " - " .. Dis .. "距离";
                    end
                end
            else
                for i, v in pairs((game:GetService("Workspace")).SeaBeasts:GetChildren()) do
            ...
            if _G.Settings.Esp["ESP Npc"] then
                for i, v in pairs((game:GetService("Workspace")).NPCs:GetChildren()) do
                    if v:FindFirstChild("HumanoidRootPart") then
                        ...
                        local Dis = math.floor((game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
                                                   v.HumanoidRootPart.Position).Magnitude);
                        v.EspNpc.TextLabel.Text = v.Name .. " - " .. Dis .. "距离";
                    end
                end
            else
                for i, v in pairs((game:GetService("Workspace")).NPCs:GetChildren()) do
...
function TweenPlayer(pos)
    ...
    local tweenTime = distance / _G.Settings.Setting["Player Tween Speed"]
    local tweenInfo = TweenInfo.new(tweenTime, Enum.EasingStyle.Linear)
    local tween = game:GetService('TweenService'):Create(humanoidRootPart, tweenInfo, {CFrame = CFrame.new(pos.Position)})
    tween:Play()
end
...
spawn(function()
    while task.wait() do
        pcall(function()
            ...
            GameTimeParagraph:SetDesc(Hour .. "天" .. Minute .. " 时" .. Second .. "分");
        end);
    end
end);
...
ChooseWeaponDropdown = Tabs.MainTab:Dropdown({
    ...
    Callback = function(option)
        ...
        _G.Settings.Main["Select Weapon"] = List[option];
        (getgenv()).SaveSetting();
    end
});
task.spawn(function()
...
local LevelFarmMethodList = {"任务", "自由", "钱"};
LevelFarmMethodDropdown = Tabs.MainTab:Dropdown({
    ...
    Callback = function(option)
        ...
        _G.Settings.Main["Farm Level Method"] = List[option];
        (getgenv()).SaveSetting();
    end
});
...
if World3 then
    MasteryMethodList = {"任务", "自由", "钱", "蛋糕岛", "骨头"};
elseif World2 or World1 then
    MasteryMethodList = {"任务", "自由", "钱"};
end
MasteryMethodDropdown = Tabs.MainTab:Dropdown({
    ...
    Callback = function(option)
        ...
        _G.Settings.Main["Mastery Method"] = List[option];
        (getgenv()).SaveSetting();
    end
});
...
if World1 then
    tableMon = {"土匪", "猴子", "大猩猩", "海盗", "暴徒", "沙漠土匪", "沙漠军官", "雪原土匪", "雪人", "海军上士", "天空土匪", "黑暗大师", "长袍战士", "角斗士", "士兵", "间谍", "鱼人战士", "鱼人突击队", "神之护卫", "山达", "皇家小队", "皇家士兵", "战舰海盗", "战舰船长"};
elseif World2 then
    tableMon = {"袭击者", "雇佣兵", "天鹅海盗", "工厂员工", "海军中尉", "海军上尉", "僵尸", "吸血鬼", "雪地士兵", "冬季战士", "实验室助手", "有角战士", "岩浆忍者", "熔岩海盗", "甲板水手", "船舶工程师", "船舶乘务员", "船舶官员", "北极战士", "雪地潜伏者", "海兵", "水战士"};
elseif World3 then
    tableMon = {"海盗百万富翁", "龙船员战士", "龙船员弓箭手", "女性岛民", "巨人岛民", "海军准将", "海军少将", "鱼人袭击者", "鱼人船长", "森林海盗", "神话海盗", "丛林海盗", "火枪手海盗", "重生骷髅", "活僵尸", "恶魔灵魂", "被附身的木乃伊", "花生侦察兵", "花生总统", "冰淇淋厨师", "冰淇淋指挥官", "饼干工匠", "蛋糕守卫", "烘焙员工", "首席面包师", "可可战士", "巧克力棒战士", "甜点小偷", "糖果反叛者", "糖果海盗", "雪魔", "岛屿亡命徒", "岛屿男孩", "阳光战士", "岛屿冠军"};
end
ChooseMonDropdown = Tabs.MainTab:Dropdown({
    ...
    Callback = function(option)
        local List = {
            ...
            ["天鹅海盗"] = "Swan Pirate",
            ["工厂员工"] = "Factory Staff",
            ["海军中尉"] = "Marine Lieutenant",
            ["海军上尉"] = "Marine Captain",
            ["僵尸"] = "Zombie",
            ["吸血鬼"] = "Vampire",
            ["雪地士兵"] = "Snow Trooper",
            ["冬季战士"] = "Winter Warrior",
            ["实验室助手"] = "Lab Subordinate",
            ["有角战士"] = "Horned Warrior",
            ["岩浆忍者"] = "Magma Ninja",
            ["熔岩海盗"] = "Lava Pirate",
            ["甲板水手"] = "Ship Deckhand",
            ...
            ["海兵"] = "Sea Soldier",
            ["水战士"] = "Water Fighter",
            ["海盗百万富翁"] = "Pirate Millionaire",
            ["龙船员战士"] = "Dragon Crew Warrior",
            ["龙船员弓箭手"] = "Dragon Crew Archer",
            ["女性岛民"] = "Female Islander",
            ["巨人岛民"] = "Giant Islander",
            ["海军准将"] = "Marine Commodore",
            ["海军少将"] = "Marine Rear Admiral",
            ["鱼人袭击者"] = "Fishman Raider",
            ["鱼人船长"] = "Fishman Captain",
            ["森林海盗"] = "Forest Pirate",
            ["神话海盗"] = "Mythological Pirate",
            ["丛林海盗"] = "Jungle Pirate",
            ["火枪手海盗"] = "Musketeer Pirate",
            ["重生骷髅"] = "Reborn Skeleton",
            ["活僵尸"] = "Living Zombie",
            ["恶魔灵魂"] = "Demonic Soul",
            ["被附身的木乃伊"] = "Posessed Mummy",
            ["花生侦察兵"] = "Peanut Scout",
            ["花生总统"] = "Peanut President",
            ["冰淇淋厨师"] = "Ice Cream Chef",
            ["冰淇淋指挥官"] = "Ice Cream Commander",
            ["饼干工匠"] = "Cookie Crafter",
            ["蛋糕守卫"] = "Cake Guard",
            ["烘焙员工"] = "Baking Staff",
            ["首席面包师"] = "Head Baker",
            ["可可战士"] = "Cocoa Warrior",
            ["巧克力棒战士"] = "Chocolate Bar Battler",
            ["甜点小偷"] = "Sweet Thief",
            ["糖果反叛者"] = "Candy Rebel",
            ["糖果海盗"] = "Candy Pirate",
            ["雪魔"] = "Snow Demon",
            ["岛屿亡命徒"] = "Isle Outlaw",
            ["岛屿男孩"] = "Island Boy",
            ["阳光战士"] = "Sun-kissed Warrior",
            ["岛屿冠军"] = "Isle Champion"
        }
        _G.Settings.Main["Selected Mon"] = List[option];
        (getgenv()).SaveSetting();
    end
});
    ...
    while wait(0.2) do
        pcall(function()
            if (game:GetService("ReplicatedStorage")):FindFirstChild(_G.Settings.Main["Selected Boss"]) or
                ...
                BossStatusParagraph:SetDesc("生成");
            else
                BossStatusParagraph:SetDesc("未生成");
            end
        end);
    end
end);
...
if World1 then
    tableBoss = {"大猩猩王", "鲍比", "雪人", "暴徒头目", "海军中将", "典狱长", "典狱长首领", "天鹅", "岩浆上将", "鱼人领主", "威斯普", "雷神", "生化人", "剑术专家"};
elseif World2 then
    tableBoss = {"钻石", "杰里米", "法希塔", "唐·天鹅", "烟雾上将", "诅咒船长", "黑胡子", "秩序", "觉醒冰上将", "潮汐守护者"};
elseif World3 then
    tableBoss = {"石头", "岛屿女皇", "基洛上将", "大象船长", "美丽海盗", "撕裂因陀罗真身", "龙马", "灵魂收割者", "蛋糕女王"};
end
ChooseBossDropdown = Tabs.MainTab:Dropdown({
    ...
    Callback = function(option)
        local List = {
            ...
            ["黑胡子"] = "Darkbeard",
            ["秩序"] = "Order",
            ["觉醒冰上将"] = "Awakened Ice Admiral",
            ["潮汐守护者"] = "Tide Keeper",
            ["石头"] = "Stone",
            ["岛屿女皇"] = "Island Empress",
            ["基洛上将"] = "Kilo Admiral",
            ["大象船长"] = "Captain Elephant",
            ["美丽海盗"] = "Beautiful Pirate",
            ["撕裂因陀罗真身"] = "rip_indra True Form",
            ["龙马"] = "Longma",
            ["灵魂收割者"] = "Soul Reaper",
            ["蛋糕女王"] = "Cake Queen"
        }
        _G.Settings.Main["Selected Boss"] = List[option];
        (getgenv()).SaveSetting();
    end
});
    ...
    while wait(0.2) do
        pcall(function()
            if (game:GetService("ReplicatedStorage")):FindFirstChild("Diablo") or
                ...
                EliteHunterParagraph:SetDesc("未生成");
            end
        end);
    end
end);
    ...
    while wait() do
        pcall(function()
            if World1 or World2 then
                EliteHunterProgressParagraph:SetDesc("仅在3海有效");
            elseif World3 then
...
local listBoneFarmMethod = {"任务", "自由"};
    ...
    while task.wait(5) do
        pcall(function()
            if World3 then
                ...
                CakePrinceStatusParagraph:SetDesc("仅在3海有效");
            end
        end);
    end
end);
...
if World1 then
    MaterialList = {"岩浆矿", "天使之翼", "皮革", "废金属"};
elseif World2 then
    MaterialList = {"放射性物质", "神秘水滴", "岩浆矿", "皮革", "灵质", "废金属"};
elseif World3 then
    MaterialList = {"皮革", "废金属", "魔法可可", "龙鳞", "火药", "鱼尾", "迷你象牙"};
end
...
MaterialDropdown = Tabs.OthersTab:Dropdown({
    ...
    Callback = function(option)
        ...
        _G.Settings.Farm["Selected Material"] = List[option];
    end
});
...
BringMobDropdown = Tabs.SettingsTab:Dropdown({
    ...
    Callback = function(option)
        ...
        _G.Settings.Setting["Bring Mob Mode"] = List[option];
    end
});
local AttackList = {"慢", "正常", "快", "很快"};
FastAttackMethodDropdown = Tabs.SettingsTab:Dropdown({
    ...
    Callback = function(option)
        ...
        _G.Settings.Setting["Fast Attack Mode"] = List[option];
    end
});
spawn(function()
    while wait() do
    ...
    pcall(function()
        while wait(0.2) do
            if (game:GetService("Players")).LocalPlayer.PlayerGui.Main.TopHUDList.RaidTimer.Visible == true then
                ...
                TimeRaidParagraph:SetDesc("等待副本开始");
            end
        end
    end);
end);
...
local BoatList = {"守护者", "野兽猎人", "海盗大船队", "海军大船队", "海盗船队", 
 "海军船队", "海盗单桅帆船", "海军单桅帆船"};
local ZoneList = {"区域1", "区域2", "区域3", "区域4", "区域5", "区域6", "无限"};
ChooseBoatDropdown = Tabs.SeaEventTab:Dropdown({
    ...
    Callback = function(option)
        local List = {
            ['守护者'] = 'Guardian',
            ['野兽猎人'] = 'Beast Hunter',
            ['海盗大船队'] = 'PirateGrandBrigade',
            ['海军大船队'] = 'MarineGrandBrigade',
            ['海盗船队'] = 'PirateBrigade',
            ['海军船队'] = 'MarineBrigade',
            ['海盗单桅帆船'] = 'PirateSloop',
            ['海军单桅帆船'] = 'MarineSloop'
        }
        _G.Settings.SeaEvent["Selected Boat"] = List[option];
        (getgenv()).SaveSetting();
    end
});
ChooseZoneDropdown = Tabs.SeaEventTab:Dropdown({
    ...
    Callback = function(option)
        ...
        _G.Settings.SeaEvent["Selected Zone"] = List[option];
        (getgenv()).SaveSetting();
    end
});
    ...
    pcall(function()
        while wait(0.2) do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
                MirageStatusSeaStackParagraph:SetDesc("✅ 幻影岛 生成");
            else
                MirageStatusSeaStackParagraph:SetDesc("❌ 幻影岛 未生成");
            end
            if game.Workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island") then
                KitsuneStatusSeaStackParagraph:SetDesc("✅ 九尾岛 生成");
            else
                KitsuneStatusSeaStackParagraph:SetDesc("❌ 九尾岛 未生成");
            end
            if game.Workspace._WorldOrigin.Locations:FindFirstChild("Frozen Dimension") then
                FrozenStatusSeaStackParagraph:SetDesc("✅ 寒冰地区 生成");
            else
                FrozenStatusSeaStackParagraph:SetDesc("❌ 寒冰地区 未生成");
            end
            if game.Workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
                PrehistoricStatusSeaStackParagraph:SetDesc("✅ 火山岛 生成");
            else
                PrehistoricStatusSeaStackParagraph:SetDesc("❌ 火山岛 未生成");
            end
        end
    end);
end);
...
Tabs.LocalPlayerTab:Slider({
    ...
    Callback = function(value)
        _G.Settings.LocalPlayer["WalkSpeed"] = tonumber(value)
    end
})
    ...
    while wait(0.2) do
        pcall(function()
            for _, v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
                if v:IsA('BasePart') or v.Name == 'HumanoidRootPart' then
        ...
        pcall(function()
            if _G.Settings.Fruit["Auto Store Fruit"] then
                for _, v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
                    if string.find(v.Name, "Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit", v.Name .. "-" .. v.Name, game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(NameFruit));
                    end
                end
            end
        end);
    ...
    while task.wait() do
        pcall(function()
            if (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149431" then
                MoonServerParagraph:SetDesc("满月 100%");
            elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149052" then
                MoonServerParagraph:SetDesc("满月 75%");
            elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709143733" then
                MoonServerParagraph:SetDesc("满月 50%");
            elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709150401" then
                MoonServerParagraph:SetDesc("满月 25%");
            elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149680" then
                MoonServerParagraph:SetDesc("满月 15%");
            else
                MoonServerParagraph:SetDesc("满月 0%");
            end
        end);
    end
end);
spawn(function()
    pcall(function()
        while wait(0.2) do
            if World3 then
                if game.Workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island") then
                    KitsuneStatusParagraph:SetDesc("✅ 九尾岛 生成");
                else
                    KitsuneStatusParagraph:SetDesc("❌ 九尾岛 未生成");
                end
            else
                KitsuneStatusParagraph:SetDesc("请到3海");
            end
        end
    end);
end);
spawn(function()
    pcall(function()
        while wait(0.2) do
            if World3 then
                if game.Workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
                    PrehistoricStatusParagraph:SetDesc("✅ 火山岛 生成");
                else
                    PrehistoricStatusParagraph:SetDesc("❌ 火山岛 未生成");
                end
            else
                PrehistoricStatusParagraph:SetDesc("请到3海");
            end
        end
    end);
end);
spawn(function()
    pcall(function()
        while wait(0.2) do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild("Frozen Dimension") then
                FrozenStatusParagraph:SetDesc("✅ 寒冰区 生成");
            else
                FrozenStatusParagraph:SetDesc("❌ 寒冰区 未生成");
            end
        end
    end);
end);
    ...
    pcall(function()
        while wait(0.2) do
            if World2 or World3 then
                if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
                    MirageStatusParagraph:SetDesc("✅ 幻影岛 生成");
                else
                    MirageStatusParagraph:SetDesc("❌ 幻影岛 未生成");
                end
            else
                MirageStatusParagraph:SetDesc("请到3海");
            end
        end
    end);
end);
        ...
        pcall(function()
            local response =
                (((game:GetService("ReplicatedStorage")):WaitForChild("Remotes")):WaitForChild("CommF_")):InvokeServer(
                    "ColorsDealer", "1");
            if response then
                HakiDealerStatusParagraph:SetDesc("✅ 武装色商人 生成");
            else
                HakiDealerStatusParagraph:SetDesc("❌ 武装色商人 未生成");
            end
        end);
    end
end);
